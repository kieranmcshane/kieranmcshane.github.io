...
class Mat101ExerciseLibraryTests(unittest.TestCase):
    ...
    def test_interactive_table_of_contents_covers_and_tracks_exercises(self):
        self.assertNotIn("Sommaire interactif", PAGE)
        self.assertIn("mat101-toc-shell", PAGE)
        ...
        self.assertIn("syncTocMode", SCRIPT)
        ...
        self.assertIn(".mat101-toc-shell", STYLES)
        self.assertIn(".mat101-toc-status", STYLES)
