...
\newenvironment{methode}{%
  \begin{center}\begin{minipage}{0.94\linewidth}
  \color{MATblue}\textbf{Méthode.}\enspace
}{%
  \end{minipage}\end{center}
}
...
\begin{enumerate}
  \item $\boxed{[2,6[}$.
  \item $|x|<0{,}5\iff-0{,}5<x<0{,}5$, donc $\boxed{]-0{,}5,0{,}5[}$.
  \item $|x-2|<0{,}1\iff1{,}9<x<2{,}1$, donc $\boxed{]1{,}9,2{,}1[}$.
  \item $|x-5|\leq0{,}01$, donc $\boxed{[4{,}99,5{,}01]}$.
  \item $|x-0{,}1|<0{,}2$, donc $\boxed{]-0{,}1,0{,}3[}$.
  \item $x^2<3\iff|x|<\sqrt3$, donc $\boxed{]-\sqrt3,\sqrt3[}$.
  \item $x^4\geq1\iff |x|\geq1$, donc
  \[
...
\begin{enumerate}
  ...
  \[
  \lfloor x\rfloor=3\iff3\leq x<4.
  \]
  Le résultat est $\boxed{[3,4[}$.
...
\begin{enumerate}
  ...
  \item
  \[
  \neg\bigl((P\Rightarrow Q)\land R\bigr)
...
\begin{enumerate}
  ...
  \item Toute valeur négative ou nulle ne peut être prise qu'en un point $x\leq0$. Par contraposée, $x>0\Rightarrow f(x)>0$.
...
\begin{enumerate}
  ...
  \item Sur la seconde branche, $f(x)<1$, donc $f(x)\geq3/2$ est impossible. Sur la première branche,
  \[
  2x+1\geq\frac32
  \iff x\geq\frac14.
  \]
  En tenant compte de $x\leq1/2$, on obtient
  \[
  \boxed{f(x)\geq\frac32\iff x\in\left[\frac14,\frac12\right]}.
  \]
\end{enumerate}
\end{corrige}
...
\begin{corrige}{4.8}
Pour $j\geq3$, on a $j-u_j\geq j-2\geq1$, donc
\[
P(i,j)\iff \frac1{j-u_j}\leq\frac1i
\iff j-u_j\geq i.
\]
Comme $u_j\in\{0,1,2\}$,
\[
