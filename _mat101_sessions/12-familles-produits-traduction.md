...
<div class="mat101-library mat101-session-page" data-mat101-session-number="12">
  <header class="mat101-session-detail-hero is-upcoming">
    <div>
      ...
      <h1>Familles et produits</h1>
      <p class="mat101-session-when">ven. 2 oct. 2026</p>
...
- Énumérer `E×F`.
- Lire union/intersection indexées avec `∃/∀`.
